							...
							<table id="bureauImageTable">
								...
								<tr id="logo">
									<td><p>
										...
										</p> <br> <input type="submit" value="Lae ¸les" id="upladIt"> <input type="hidden" name="generalId" value="<%=request.getAttribute("bureauId")%>"> <input type="hidden" name="isBureau" value="1"></td>
							...
							<form action="<%=request.getContextPath()%>/BureauEditServlet" method="post" class="cascade" id="edit_form">
								<table id="bureauProfileTable">
									...
									<tr>
										...
										<td><input type="text" id="profileBureauPhone" name="profileBureauPhone" onkeyup="validatePhoneNumber()" autocomplete="off" value="<%=currentUser.getPhone()%>">
										<input type="hidden" id="oldPhone" name="oldPhone" value="<%=currentUser.getPhone()%>"></td>
										<td><span id="phoneMessage"></span></td>
									</tr>

									<tr>
										<td><label for="profileBureauEmail">E-mail:</label></td>
										<td><input type="text" id="profileBureauEmail" name="profileBureauEmail" onkeyup="validateEmail()" value="<%=currentUser.getEmail()%>">
										<input type="hidden" id="oldEmail" name="oldEmail" value="<%=currentUser.getEmail()%>"></td>
										<td><span id ="emailErrorMessage"></span></td> 
									</tr>

									<tr>
										<td><label for="profileBureauAddress">Aadress:</label></td>
										<td><input type="text" id="profileBureauAddress" name="profileBureauAddress" onkeyup="validateStreetAddress()" autocomplete="off" value="<%=currentUser.getStreet()%>">
										<input type="hidden" id="oldAddress" name="oldAddress" value="<%=currentUser.getStreet()%>"></td>
										<td><span id="streetAddressMessage"></span></td>
									</tr>
									<tr>
										<td><label for="profilePostalCode">Postiindeks:</label>
										<td><input type="text" name="profilePostalCode" id="profilePostalCode" onkeyup="validatePostalCode()" autocomplete="off" value="<%=currentUser.getPostalcode()%>" />
										<input type="hidden" id="oldPostalCode" name="oldPostalCode" value="<%=currentUser.getPostalcode()%>"></td>
									...
									<tr>
										...
										<td><input type="text" id="avgPrice" name="profileBureauAveragePrize" onkeyup="validateAveragePrice()" autocomplete="off" value="<%=currentUser.getAveragePrice()%>">
										<input type="hidden" id="oldPrice" name="oldPrice" value="<%=currentUser.getAveragePrice()%>"></td>
									...
									<tr>
										...
										<td><input type="password" id="profilePassword" name="newPass" onkeyup="validatePassword()" value="">
										<input type="hidden" id="oldPassword" name="oldPassword" value="<%=currentUser.getPassword()%>"></td>
