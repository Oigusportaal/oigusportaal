							...
							<table id="bureauImageTable">
								...
								<tr id="logo">
									<td><p>
										...
										</p> <br> <input type="submit" value="Lae ¸les" id="upladIt"> <input type="hidden" name="generalId" value="<%=request.getAttribute("bureauId")%>"> <input type="hidden" name="action" value="1"></td>
